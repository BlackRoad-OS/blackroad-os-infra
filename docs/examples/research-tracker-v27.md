# 🧩 EXAMPLES PACK v27 (research + docs) — 7 papers × 7 stages
...
1️⃣ **Find** - Discover and identify relevant papers
2️⃣ **Read** - Initial reading and comprehension
3️⃣ **Notes** - Take detailed notes and highlights
4️⃣ **Outline** - Create structured outline of key points
5️⃣ **Draft** - Write draft summary or analysis
6️⃣ **Review** - Review and refine content
7️⃣ **Publish** - Finalize and publish/share
...
1. **Copy this template** for your research tracking needs
2. **Fill in paper titles** by replacing the `__________` placeholders
3. **Update status indicators** as you progress through each stage
4. **Add week/date** in the header for time tracking
5. **Customize stages** if your workflow differs

### Status Indicators

- 🟢 **Done** - Stage completed successfully
- 🟡 **In Progress** - Currently working on this stage
- 🔴 **Blocked** - Blocked or encountering issues
